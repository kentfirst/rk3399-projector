...
public class NavigationBarFragment extends Fragment implements Callbacks {
    ...
    private void prepareNavigationBarView() {
        ...
        //Brightness
        ButtonDispatcher brightnessButton=mNavigationBarView.getVolumeAddButton();
        brightnessButton.setOnClickListener(this:: BrightnessClick);
        brightnessButton.setOnTouchListener(this:: BrightnessTouch);
